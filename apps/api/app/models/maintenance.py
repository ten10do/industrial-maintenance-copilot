...
if TYPE_CHECKING:
    from app.models.equipment import SparePart
...
class WorkOrderSparePart(TimestampMixin, Base):
    ...
    spare_part_id: Mapped[int | None] = mapped_column(
        ForeignKey("spare_parts.id", ondelete="SET NULL"), nullable=True
    )
...
class Attachment(TimestampMixin, Base):
    ...
    fault_report_id: Mapped[int | None] = mapped_column(
        ForeignKey("fault_reports.id", ondelete="CASCADE"), nullable=True, index=True
    )
