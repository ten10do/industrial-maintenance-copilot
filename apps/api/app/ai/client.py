...
class LLMClient:
    ...
    def chat(self, messages: list[dict], json_mode: bool = False) -> dict[str, Any]:
...
def record_ai_interaction(
    ...
    try:
        ...
        status = AIStatusEnum.mock if is_mock else (AIStatusEnum.failed if error else AIStatusEnum.success)
        rec = AIInteraction(
            user_id=user_id,
