...
class KnowledgeArticle(AuditMixin, Base):
    ...
    category: Mapped[KnowledgeCategoryEnum] = mapped_column(
        Enum(KnowledgeCategoryEnum), default=KnowledgeCategoryEnum.experience, index=True
    )
...
class AIInteraction(TimestampMixin, Base):
    ...
    interaction_type: Mapped[AIInteractionTypeEnum] = mapped_column(Enum(AIInteractionTypeEnum), index=True)
    request: Mapped[str] = mapped_column(Text)
    response: Mapped[str | None] = mapped_column(Text, nullable=True)
    status: Mapped[AIStatusEnum] = mapped_column(Enum(AIStatusEnum), default=AIStatusEnum.mock)
